...
public:
  ...
  std::string public_encrypt(const std::string &) const override;
  std::string public_decrypt(const std::string &) const override;
  std::string private_encrypt(const std::string &) const override;
  std::string private_decrypt(const std::string &) const override;
